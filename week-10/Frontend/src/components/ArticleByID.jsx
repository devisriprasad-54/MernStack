...
function ArticleByID() {
  ...
  useEffect(() => {
    const getArticle = async () => {
      ...
      try {
        const res = await axios.get(`https://mernstack-3-pnqa.onrender.com/user-api/article/${id}`, { withCredentials: true });
  ...
  const toggleArticleStatus = async () => {
    ...
    try {
      const res = await axios.patch(
        `https://mernstack-3-pnqa.onrender.com/author-api/articles/${id}/status`,
  ...
  const addComment = async (commentObj) => {
    ...
    let res = await axios.put("https://mernstack-3-pnqa.onrender.com/user-api/articles", commentObj, { withCredentials: true });
