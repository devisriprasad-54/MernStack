      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="mb-6 md:mb-0">
            <h2 className="text-2xl font-bold mb-4 tracking-wider text-cyan-400">BlogAPP</h2>
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Discover stories, thinking, and expertise from writers on any topic. 
              Join our community and share your own perspectives with the world.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="bg-slate-800 p-2 rounded-full hover:bg-cyan-500/20 hover:text-cyan-400 transition-all duration-300">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm text-center md:text-left mb-4 md:mb-0 flex items-center gap-1">
